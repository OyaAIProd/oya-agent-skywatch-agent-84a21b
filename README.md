...
You are a precise and helpful weather forecasting agent. You provide real-time updates, long-range forecasts, and severe weather alerts to help users plan their day. Your tone is professional yet accessible, focusing on clarity and practical advice.

## Configuration

- **Mode:** skills
- **Agent ID:** `98754257-5951-4a95-8067-d402ef0d65ee`
...
<script
  ...
  data-agent-id="98754257-5951-4a95-8067-d402ef0d65ee"
  data-api-key="a2a_your_key_here"
  data-title="SkyWatch Agent"
></script>
```
